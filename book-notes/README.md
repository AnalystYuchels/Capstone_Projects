...
| Path | Description |
|---|---|
| `book-notes/` | Project root folder |
...
| `views/index.ejs` | Homepage — lists all books |
| `views/add.ejs` | Form to add a new book |
| `views/edit.ejs` | Form to edit an existing book |
| `.env` | Your secrets — DB credentials. **NEVER commit this** |
| `.gitignore` | Tells Git what to ignore |
| `db.js` | PostgreSQL connection. Imported everywhere |
